...
import { useUserPreferences, useUpdatePreferences, useSendTestNotification } from '@/hooks/usePreferences'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        >
          ...
          <p className="text-[11px] text-base-content/60 leading-relaxed">
            Alertas detalladas con formato HTML premium enviadas a tu correo institucional.
          </p>
          <div className="text-[10px] text-primary font-semibold flex items-center gap-1">
            <CheckCircle2 className="w-3 h-3" /> Motor Nodemailer Activo
          </div>
        </div>
        ...
        >
          ...
          <p className="text-[11px] text-base-content/60 leading-relaxed">
            Mensajes directos vía WhatsApp Web / App y despacho automático vía API.
          </p>
      ...
      <div className="pt-3 border-t border-base-200 grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
        ...
        <div className="form-control">
          ...
          <span className="text-[10px] text-base-content/40 mt-1">
            Ejemplo: +502 (Guatemala), +52 (México), +1 (EE.UU.). Formato E.164.
          </span>
        </div>
      ...
      <div className="rounded-xl border border-base-200 overflow-hidden bg-base-200/30">
        ...
        >
          <span className="flex items-center gap-2">
            ...
            ¿Deseas conectar tu propio correo de Gmail u Outlook? (Guía de 2 minutos)
          </span>
        ...
        {showSmtpGuide && (
          <div className="p-4 pt-2 border-t border-base-200 text-xs text-base-content/70 flex flex-col gap-2 leading-relaxed bg-base-100/50">
            <p>
              AgendaPro ya incluye envío de correo real. Si deseas que los correos salgan desde tu propia cuenta de Gmail:
            </p>
            <ol className="list-decimal pl-5 flex flex-col gap-1.5">
              <li>
                Ve a tu <strong>Cuenta de Google</strong> &gt; <strong>Seguridad</strong> &gt; <strong>Verificación en 2 pasos</strong>.
              </li>
              <li>
                Al final de la página, selecciona <strong>Contraseñas de aplicaciones</strong>.
              </li>
              <li>
                Crea una para <em>AgendaPro</em> y obtendrás una contraseña de 16 letras.
              </li>
              <li>
                Abre el archivo <code className="bg-base-200 px-1.5 py-0.5 rounded font-mono">backend/.env</code> y coloca:
                <pre className="mt-1.5 p-2.5 bg-neutral text-neutral-content rounded-lg font-mono text-[11px] overflow-x-auto">
{`SMTP_HOST=smtp.gmail.com
SMTP_PORT=587
SMTP_USER=tu-correo@gmail.com
SMTP_PASS=tu-clave-de-16-letras
SMTP_FROM="AgendaPro Académico" <tu-correo@gmail.com>`}
                </pre>
              </li>
            </ol>
            <p className="text-[11px] text-base-content/50 mt-1">
              Si aún no configuras tus credenciales personales, el sistema utiliza el servidor de pruebas real <strong>Ethereal Email</strong>, que genera una URL web en vivo para ver el correo renderizado con diseño completo.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="pt-3 border-t border-base-200 flex flex-col gap-3 bg-base-200/40 p-4 rounded-xl">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h4 className="font-semibold text-xs text-base-content">
              Validar Entrega en Vivo
            </h4>
            <p className="text-[11px] text-base-content/60">
              Despacha un recordatorio real hacia el canal seleccionado.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="btn btn-primary btn-xs rounded-lg gap-1 font-semibold"
            >
              {sendTest.isPending ? (
        ...
        {/* Banner de previsualización web de correo Ethereal */}
        {lastEmailPreviewUrl && (
          <div className="alert alert-info py-2.5 px-3.5 text-xs rounded-xl flex items-center justify-between gap-2 shadow-xs">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="truncate">
                ¡Correo generado y entregado! Puedes inspeccionar el diseño HTML en el visor web.
              </span>
            </div>
            <a
