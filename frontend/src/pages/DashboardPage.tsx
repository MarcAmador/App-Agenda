  ...
  return (
    <AppLayout pageTitle="Dashboard">
      <div className="flex flex-col gap-7 animate-fade-in pb-8">
        ...
        {preferences.showDashboardWelcome ? (
          <div
            id="tour-welcome"
          ...
          <div className="flex items-center justify-between gap-3 pb-3 border-b border-base-200 flex-wrap">
            <div>
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={openFocusModal}
                className="btn btn-outline btn-sm rounded-xl gap-2 font-bold text-xs"
              >
        ...
        {(preferences.showDashboardPriorityDistribution || preferences.showDashboardUpcoming) && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">

            {/* Widget 1: Distribución Eisenhower (4 Cuadrantes) */}
            {preferences.showDashboardPriorityDistribution && (
              <div id="tour-priority-summary" className={`${preferences.showDashboardUpcoming ? 'lg:col-span-5' : 'lg:col-span-12'} card bg-base-100 border border-base-200 shadow-xs rounded-2xl p-5 flex flex-col justify-between gap-4`}>
            ...
            {preferences.showDashboardUpcoming && (
              <div id="tour-upcoming-tasks" className={`${preferences.showDashboardPriorityDistribution ? 'lg:col-span-7' : 'lg:col-span-12'} card bg-base-100 border border-base-200 shadow-xs rounded-2xl p-5 flex flex-col justify-between gap-4`}>
                <div className="flex items-center justify-between border-b border-base-200 pb-3">
                  <div className="flex items-center gap-2">
        ...
        {preferences.showDashboardQuickModules && (
